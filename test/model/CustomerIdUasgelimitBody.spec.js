...
(function(root, factory) {
  ...
  describe('BillaBear', function() {
    describe('CustomerIdUasgelimitBody', function() {
      beforeEach(function() {
        instance = new BillaBear.CustomerIdUasgelimitBody();
      });

      it('should create an instance of CustomerIdUasgelimitBody', function() {
        // TODO: update the code to test CustomerIdUasgelimitBody
        expect(instance).to.be.a(BillaBear.CustomerIdUasgelimitBody);
      });
