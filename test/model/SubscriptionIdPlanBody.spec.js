...
(function(root, factory) {
  ...
  describe('BillaBear', function() {
    describe('SubscriptionIdPlanBody', function() {
      beforeEach(function() {
        instance = new BillaBear.SubscriptionIdPlanBody();
      });

      it('should create an instance of SubscriptionIdPlanBody', function() {
        // TODO: update the code to test SubscriptionIdPlanBody
        expect(instance).to.be.a(BillaBear.SubscriptionIdPlanBody);
      });
