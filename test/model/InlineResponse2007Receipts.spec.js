...
(function(root, factory) {
  ...
  describe('BillaBear', function() {
    describe('InlineResponse2007Receipts', function() {
      beforeEach(function() {
        instance = new BillaBear.InlineResponse2007Receipts();
      });

      it('should create an instance of InlineResponse2007Receipts', function() {
        // TODO: update the code to test InlineResponse2007Receipts
        expect(instance).to.be.a(BillaBear.InlineResponse2007Receipts);
      });
