 ...
 * @module BillaBear/model/InlineResponse2003
 * @version 1.0.0
 */
export default class InlineResponse2003 {
  /**
   * Constructs a new <code>InlineResponse2003</code>.
   * @alias module:BillaBear/model/InlineResponse2003
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:BillaBear/model/InlineResponse2003} obj Optional instance to populate.
   * @return {module:BillaBear/model/InlineResponse2003} The populated <code>InlineResponse2003</code> instance.
   */
 ...
 */
InlineResponse2003.prototype.lastKey = undefined;
