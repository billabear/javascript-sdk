 ...
 * @module BillaBear/model/InlineResponse20010
 * @version 1.0.0
 */
export default class InlineResponse20010 {
  /**
   * Constructs a new <code>InlineResponse20010</code>.
   * @alias module:BillaBear/model/InlineResponse20010
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:BillaBear/model/InlineResponse20010} obj Optional instance to populate.
   * @return {module:BillaBear/model/InlineResponse20010} The populated <code>InlineResponse20010</code> instance.
   */
 ...
 */
InlineResponse20010.prototype.lastKey = undefined;
