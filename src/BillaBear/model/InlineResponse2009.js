 ...
 * @module BillaBear/model/InlineResponse2009
 * @version 1.0.0
 */
export default class InlineResponse2009 {
  /**
   * Constructs a new <code>InlineResponse2009</code>.
   * @alias module:BillaBear/model/InlineResponse2009
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:BillaBear/model/InlineResponse2009} obj Optional instance to populate.
   * @return {module:BillaBear/model/InlineResponse2009} The populated <code>InlineResponse2009</code> instance.
   */
...
/**
 * @member {Array.<module:BillaBear/model/InlineResponse2009Data>} data
 */
 ...
 */
InlineResponse2009.prototype.lastKey = undefined;
