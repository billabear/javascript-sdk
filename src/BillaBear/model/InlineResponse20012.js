 ...
 * @module BillaBear/model/InlineResponse20012
 * @version 1.0.0
 */
export default class InlineResponse20012 {
  /**
   * Constructs a new <code>InlineResponse20012</code>.
   * @alias module:BillaBear/model/InlineResponse20012
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:BillaBear/model/InlineResponse20012} obj Optional instance to populate.
   * @return {module:BillaBear/model/InlineResponse20012} The populated <code>InlineResponse20012</code> instance.
   */
